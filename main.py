    ...
    if args.run_all:
        ...
        if args.run_all and args.test:
            ...
            y_rmse_all_splits_list = [
                metric_list[rmse_idx]
                for metric_list in y_rmse_all_splits_all_steps_list
            ]
            y_qice_all_splits_list = [
                metric_list[qice_idx]
                for metric_list in y_qice_all_splits_all_steps_list
            ]
            y_picp_all_splits_list = [
                metric_list[picp_idx]
                for metric_list in y_picp_all_splits_all_steps_list
            ]
            ...
            if not os.path.exists(im_path):
                os.makedirs(im_path)
            fig.savefig(
                os.path.join(im_path, "mean_metrics_all_splits_all_timesteps.pdf")
            )
